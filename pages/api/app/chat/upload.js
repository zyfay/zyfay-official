...
export default async function handler(req, res) {
  ...
  try {
    ...
    const { error: uploadErr } = await supabaseAdmin.storage.from('images').upload(fileName, buffer, { contentType });
    ...
    console.error('App chat upload error:', e);
