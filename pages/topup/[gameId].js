          ...
          {step === 3 && (
            <div>
              ...
              <div className="card p-4 mb-5 flex items-center gap-3">
                <div className="w-10 h-10 bg-pink-500/15 rounded-xl flex items-center justify-center flex-shrink-0 text-lg font-bold text-pink-400">
                  QR
                </div>
              ...
              {paymentData?.qr_image ? (
                <div className="card p-6 mb-5 text-center space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted text-xs mt-3">
                      Scan dengan GoPay, OVO, DANA, ShopeePay, LinkAja, atau mobile banking manapun
                    </p>
                  </div>
                  ...
                  {paymentData.qr_string && (
                    <div>
                      <div className="text-muted text-xs mb-1">Atau salin kode QR</div>
                      <div className="flex items-center gap-2 bg-card rounded-xl p-3 border border-border">
                        ...
                        <button
                          onClick={() => copyToClipboard(paymentData.qr_string)}
                ...
                <div className="card p-6 mb-5 text-center">
                  ...
                  <p className="text-muted text-xs mt-1">
                    Jika lama, coba refresh atau hubungi admin.
                  </p>
                </div>
              )}
