...
import {
  ...
  CheckCircle, XCircle, AlertCircle, Search, Eye, EyeOff, Zap, Wrench, Flame, Bell, Megaphone, CalendarClock, Images
} from 'lucide-react';
                  ...
                  <div key={msg.id} className={`flex ${msg.sender === 'admin' ? 'justify-end' : 'justify-start'}`}>
                    <div className={msg.sender === 'admin' ? 'bubble-user' : 'bubble-admin'}>
                      {msg.message_type === 'image' && msg.media_url ? (
                        ...
                        <audio controls src={msg.media_url} className="max-w-[220px] h-9" />
                      ) : (
                        <div>{msg.text}</div>
                      )}
