...
import { ArrowLeft, Loader2, Copy, Check, RefreshCw, AlertCircle, XCircle } from 'lucide-react';
        ...
        <div className="max-w-md mx-auto px-4 py-8">
          ...
          {['failed', 'expired'].includes(order.order_status) ? (
            <div className="card p-6 text-center">
              ...
              <p className="font-semibold mb-1">Pesanan ini sudah {order.order_status === 'failed' ? 'gagal' : 'kedaluwarsa'}</p>
